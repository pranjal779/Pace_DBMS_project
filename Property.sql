...
Property_ID,Property_Owner_ID,Address_ID,Property_Type,Property_Status,Property_Payment,Basement,Property_Floor,Bedrooms,Bathrooms,Year_Of_Built,Square_Feet,Landscape,Special_Requirement,Posted_Date,Available_Date)
